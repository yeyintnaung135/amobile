...
<section class="row justify-content-center bg-white">
  ...
  <div class="px-3 px-lg-5">
    <div class="row">
      <h3 class="d-none d-md-block my-4">Samsung Galaxy Z Fold</h3>
              ...
              <div class="swiper productDetailSwiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" data-src="{{ asset('images/products/samsung.png')}}" data-fancybox="product_detail">
                      <img src="{{ asset('images/products/samsung.png')}}"/>
                    </div>
      ...
      <div class="col-12 col-md-6 product-detail-info">
        <h4 class="product-title d-flex align-items-center align-self-center">Samsung Galaxy Z Fold <div class="sn-instock d-block d-md-none ms-3" style="font-size: 14px;">Instock 2</div></h4>
        <div class="product-price my-2">$2500</div>
        <div class="sn-instock d-none d-md-block">Instock 2</div>
        <div>
          <h5 class="my-2">Color : Purple</h5>
          <label class="indigo">
            <input type="radio" name="color" value="indigo">
            <div class="layer"></div>
            <div class="color-button color-button-active"><span style="background: purple;"></span></div>
          </label>
          <label class="indigo">
            <input type="radio" name="color" value="indigo">
            <div class="layer"></div>
            <div class="color-button"><span style="background: black;"></span></div>
          </label>
          <label class="indigo">
            <input type="radio" name="color" value="indigo">
            <div class="layer"></div>
            <div class="color-button"><span style="background: grey;"></span></div>
          </label>
        </div>
